...
//ResultSet rs = st.executeQuery("call hospital_data()");//procedure fx;
...
<td><a href="updateHospital.jsp?id=<%=rs.getString(1)%>">Edit</a></td>
<td><a href="deleteHospital.jsp?id=<%=rs.getString(1)%>">Delete</a></td>
</tr>
<%
}
}
